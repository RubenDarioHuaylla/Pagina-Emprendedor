...
import GenerateAIDescriptionModal from '../components/GenerateAIDescriptionModal';
...
export default function MisProductos() {
  ...
  const handleDescriptionGenerated = (description) => {
    setForm((prevForm) => ({ ...prevForm, descripcion_larga: description }));
  };
